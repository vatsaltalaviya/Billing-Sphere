...
const TaxCategory = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(`${import.meta.env.VITE_BASE_URL}/tax/createTax`,texData,{
        headers:{
          Authorization:`${token}`
        }
      })
      ...
      <div className="md:w-3xl border-2 mx-auto mt-30 p-2">
        <form onSubmit={handleSubmit} className="space-y-3">
          <div className="flex flex-col md:flex-row xl:items-center">
            ...
            <input type="text" className="flex-1 border py-2 px-2 " value={texCategory.TaxCategoryName} onChange={(e)=>{
              const update = {...texCategory};
          ...
          <div className="flex gap-2 flex-col md:flex-row">
            <div className="flex flex-col md:flex-row xl:items-center">
              ...
              <select className="flex-1 md:w-32 border py-2 px-2" value={texCategory.taxType} onChange={(e)=>{
              const update = {...texCategory};
            ...
            <div className="flex flex-col md:flex-row xl:items-center">
              ...
              <select className="flex-1 md:w-32 border py-2 px-2" value={texCategory.isActive} onChange={(e)=>{
              const update = {...texCategory};
          ...
          <div className="flex gap-2 flex-col md:flex-row">
            <div className="flex flex-col md:flex-row xl:items-center">
              ...
              <input type="number" className="flex-1 md:w-32 border py-2 px-2" onChange={(e)=>{
              const update = {...texCategory};
            ...
            <div className="flex flex-col md:flex-row xl:items-center">
              ...
              <input type="number" className="w-32 border py-2 px-2" onChange={(e)=>{
              const update = {...texCategory};
          ...
          <div className="flex gap-2 flex-col md:flex-row">
            <div className="flex flex-col md:flex-row xl:items-center">
              ...
              <input type="number" className="w-32 border py-2 px-2" value={texCategory.SGST||''} readOnly/>
            </div>
            <div className="flex flex-col md:flex-row xl:items-center">
              <span className="w-22 font-medium">CGST%</span>
              <input type="number" className="w-32 border py-2 px-2" value={texCategory.CGST||''} readOnly/>
                
            </div>
            <div className="flex flex-col md:flex-row xl:items-center">
              <span className="w-20 font-medium">Cess%</span>
              <input type="number" className="w-32 border py-2 px-2" value={texCategory.Cess2} onChange={(e)=>{
              const update = {...texCategory};
          ...
          <div className="flex flex-col md:flex-row xl:items-center">
            ...
            <input type="number" className="flex-1 border py-2 px-2 " value={texCategory.additonalCess} onChange={(e)=>{
              const update = {...texCategory};
          ...
          <div className="flex gap-2 flex-col md:flex-row">
            <div className="flex flex-col md:flex-row xl:items-center">
              ...
              <select className="w-32 border py-2 px-2" value={texCategory.taxOnMrp} onChange={(e)=>{
              const update = {...texCategory};
              update.TaxCategoryName = e.target.value;
              settexCategory(update)
            }}>
            ...
            <div className="flex flex-col md:flex-row xl:items-center">
              ...
              <select className="w-32 border py-2 px-2" value={texCategory.Exempted} onChange={(e)=>{
              const update = {...texCategory};
