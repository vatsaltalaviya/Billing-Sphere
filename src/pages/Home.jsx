...
const Home = () => {
  ...
  const rows = [
    ...
    { description: "RECEIPT", may1: "1,000.00", may25: "1,000.00", year: "0.01" },
    { description: "PAYMENT", may1: "0", may25: "500.00", year: "0" },
    { description: "EXPENSE", may1: "1,000.00", may25: "1,500.00", year: "0.02" },
  ...
  return (
    <div className="px-32 relative w-full">
      <div className="py-5">
          ...
          <div className=" backdrop-blur-sm border flex flex-col justify-center">
            ...
            <div className="p-3 flex">
              <div className="w-1/2">
                ...
                <div className="w-52 gap-0.5 flex flex-col mt-2">
                  <ButtonGroup className='border text-lg font-medium px-4 bg-amber-300 block w-full text-left hover:bg-amber-500' data={Transaction} />
                </div>
              </div>
              <div className="w-1/2">
                <h1 className="text-xl font-bold text-red-700 underline underline-offset-4">
                ...
                <div className="w-52 gap-0.5 flex flex-col mt-2">
                  <ButtonGroup className='border text-lg font-medium px-4 bg-amber-300 block w-full text-left hover:bg-amber-500' data={AccountReport} />
                </div>
              </div>
            </div>
            <div className="p-3 flex">
              <div className="w-1/2">
                ...
                <div className="w-52 gap-0.5 flex flex-col mt-2">
                  <ButtonGroup className='border text-lg font-medium px-4 bg-amber-300 block w-full text-left hover:bg-amber-500' data={Master} />
                </div>
              </div>
              <div className="w-1/2">
                <h1 className="text-xl font-bold text-red-700 underline underline-offset-4">
                ...
                <div className="w-52 gap-0.5 flex flex-col mt-2">
                  <ButtonGroup className='border text-lg font-medium px-4 bg-amber-300 block w-full text-left hover:bg-amber-500' data={InventoryReport} />
                </div>
              </div>
            </div>
            <div className="p-3 flex">
              <div className="w-1/2">
                ...
                <div className="w-52 gap-0.5 flex flex-col mt-2">
                  <ButtonGroup className='border text-lg font-medium px-4 bg-amber-300 block w-full text-left hover:bg-amber-500' data={FavouriteShortCut1} />
                </div>
              </div>
              <div className="w-1/2">
                <div className="w-52 gap-0.5 flex flex-col mt-10">
                  <ButtonGroup className='border text-lg font-medium px-4 bg-amber-300 block w-full text-left hover:bg-amber-500' data={FavouriteShortCut2} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full border mt-3">
            <div className=" backdrop-blur-sm border flex flex-col justify-center">
              ...
              <button className="text-sm font-medium px-5 py-0.5 bg-white border rounded">
                ...
                <div className="w-full flex flex-col h-76 overflow-y-auto">
                      ...
                      <table className="table-auto border-collapse border border-black w-full text-sm">
                        <thead>
                          <tr className="bg-white text-purple-900 font-bold">
                            ...
                            <th className="border border-black px-3 py-1">1-May</th>
                            <th className="border border-black px-3 py-1">May-25</th>
                            <th className="border border-black px-3 py-1">25–26 (Lacs)</th>
                          </tr>
                        </thead>
                        <tbody>
                          {rows.map((row, idx) => (
                            <tr key={idx}>
                              <td className="border border-black px-3 py-1 font-semibold">{row.description}</td>
                              <td className="border border-black px-3 py-1 text-right">{row.may1}</td>
                              <td className="border border-black px-3 py-1 text-right">{row.may25}</td>
                              <td className="border border-black px-3 py-1 text-right">{row.year}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
