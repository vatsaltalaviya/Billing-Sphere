...
const Contra = () => {
  ...
  const ReceiptsidebarData = [
    ...
    { name: "GST Exp", onClick: () => {}, navigate: "/dashboard/gstexpense" },
    {
      name: "Previous",
      onClick: () => {
        setTriggerPrevious((prev) => (prev > 1 ? prev - 1 : 1));
      },
    },
    {
      name: "Next",
      onClick: () => {
        setTriggerPrevious((prev) => prev + 1);
      },
    },
    ...
    },
    {
      name: "Goto Date",
      onClick: () => {
        setFocusDateTrigger((p) => !p);
      },
    },
    {
      name: "Attach. Img",
      onClick: () => {
        setshowAttachImages(true);
      },
    },
  ...
  return (
    <div>
      <BasePage
        heading="Voucher Entry"
        subHeading="Contra"
        mode="Contra"
        Sidebardata={ReceiptsidebarData}
      ...
      {showAttachImages && (
        <AttachImage onClose={() => setshowAttachImages(false)} />
      )}
    </div>
  );
};
